...
public class BeerWerks extends JFrame {
	...
	ImageIcon clico = new ImageIcon("../img/icons/clico.jpg");
	ImageIcon tvico = new ImageIcon("../img/icons/tableview.jpg") ;
	ImageIcon dslico = new ImageIcon("../img/icons/demote.jpg") ;
	ImageIcon fmpico = new ImageIcon("../img/icons/print.jpg") ;
	ImageIcon alico = new ImageIcon("../img/icons/addtheme.jpg") ;
	ImageIcon rlico = new ImageIcon("../img/icons/delete.jpg") ;
	ImageIcon leico = new ImageIcon("../img/icons/properties.jpg") ;
	ImageIcon helpico = new ImageIcon("../img/icons/help.png");
	static ImageIcon pslico = new ImageIcon("../img/icons/promote.jpg") ;
	...
	JButton prtjb = new JButton(new ImageIcon("../img/icons/print.jpg"));
	JButton addlyrjb = new JButton(new ImageIcon("../img/icons/addtheme.jpg"));
	JButton ptrjb = new JButton(new ImageIcon("../img/icons/pointer.jpg"));
	JButton distjb = new JButton(new ImageIcon("../img/icons/measure_1.jpg"));
	JButton XYjb = new JButton("XY");
	JButton hotjb = new JButton(new ImageIcon("../img/icons/hotlink-tbar.jpg"));
	JButton helptooljb = new JButton(new ImageIcon("../img/icons/help2.png"));

	// Setup the hotlink tool here...
	Toolkit tk = Toolkit.getDefaultToolkit();
	Image bolt = tk.getImage("../img/icons/hotlink.png");
		...
		public void actionPerformed(ActionEvent ae) {
			...
			if (o == nameField) {
				...
				try {
					...
					//		(BeerWerks.layer4.getLayerSource())).getPath();
...
class HotPick extends JDialog {
	...
	String[][] b = new String[][] {
			{ "../img/photos/ott/img_3871.JPG", "../img/photos/ott/img_3874.JPG",
			  "../img/photos/ott/img_3875.JPG", "../img/photos/ott/img_3877.JPG",
			  "../img/photos/ott/img_3879.JPG", "../img/photos/ott/img_3880.JPG" },
			{ "../img/photos/la/img_3926.JPG", "../img/photos/la/img_3928.JPG",
			  "../img/photos/la/img_3929.JPG", "../img/photos/la/img_3930.JPG",
			  "../img/photos/la/img_3931.JPG", "../img/photos/la/img_3933.JPG",
			  "../img/photos/la/img_3937.JPG", "../img/photos/la/img_3938.JPG" },
			{ "../img/photos/dd/img_3919.JPG", "../img/photos/dd/img_3920.JPG",
			  "../img/photos/dd/img_3921.JPG", "../img/photos/dd/img_3922.JPG",
			  "../img/photos/dd/img_3923.JPG", "../img/photos/dd/img_3924.JPG",
			  "../img/photos/dd/img_3925.JPG" },
			{ "../img/photos/rc/img_3910.JPG", "../img/photos/rc/img_3913.JPG",
			  "../img/photos/rc/img_3914.JPG", "../img/photos/rc/img_3916.JPG",
			  "../img/photos/rc/img_3918.JPG" },
			{ "../img/photos/tb/img_3881.JPG", "../img/photos/tb/img_3882.JPG",
			  "../img/photos/tb/img_3883.JPG", "../img/photos/tb/img_3884.JPG",
			  "../img/photos/tb/img_3886.JPG", "../img/photos/tb/img_3887.JPG",
			  "../img/photos/tb/img_3888.JPG", "../img/photos/tb/img_3889.JPG",
			  "../img/photos/tb/img_3890.JPG", "../img/photos/tb/img_3891.JPG" },
			{ "../img/photos/ij/20141123_144718.jpg",
			  "../img/photos/ij/20141123_144726.jpg",
			  "../img/photos/ij/img_3892.JPG", "../img/photos/ij/img_3894.JPG",
			  "../img/photos/ij/img_3896.JPG", "../img/photos/ij/img_3897.JPG",
			  "../img/photos/ij/img_3898.JPG", "../img/photos/ij/img_3900.JPG",
			  "../img/photos/ij/img_3901.JPG", "../img/photos/ij/img_3902.JPG",
			  "../img/photos/ij/img_3903.JPG" },
			{ "../img/photos/me/img_3904.JPG", "../img/photos/me/img_3905.JPG",
			  "../img/photos/me/img_3906.JPG", "../img/photos/me/img_3907.JPG",
			  "../img/photos/me/img_3908.JPG", "../img/photos/me/img_3909.JPG" },
			{ "../img/photos/gf/20141112_164444.jpg",
			  "../img/photos/gf/20141112_16511.jpg",
			  "../img/photos/gf/20141112_164657.jpg" },
			{ "../img/photos/bp/img_3939.JPG", "../img/photos/bp/img_3940.JPG",
			  "../img/photos/bp/img_3941.JPG", "../img/photos/bp/img_3942.JPG",
			  "../img/photos/bp/img_3943.JPG", "../img/photos/bp/img_3944.JPG" }
		} ;
	...
	public HotPick(int id, Row row, int activeLayerIndex, Map map)
		...
		final JButton jb = new JButton("Click Here To Open Website",
				new ImageIcon("../img/icons/globe.png"));
