...
//===========================================================================
public class Casinos extends JFrame {
	...
	String s1 = "C:/Casinos/data/sdcounty.shp";
	String s2 = "C:/Casinos/data/Casino.shp";
	String datapathname = "";
	String legendname = "";
			...
			public void actionPerformed(ActionEvent ae) {
				...
				if (source == cancel) {
					...
					try {
						...
						map.redraw();
						if (Casinos.stb.getSelectedLayers() != null) {
							Casinos.pitem.setEnabled(true);
						}
					} catch(IOException e){}
				}
			}
...
class AttrTab extends JDialog {
	JPanel panel1 = new JPanel();
	com.esri.mo2.map.dpy.Layer layer = Casinos.layer4;
	...
	ActionListener lis = new ActionListener() {
		public void actionPerformed(ActionEvent ae) {
			...
			if (o == nameField) {
				...
				try {
					//path = ((ShapefileFolder)(Casinos.layer4.getLayerSource())).getPath();
					path = "C:\\Casinos\\data\\CreatedSHPFiles";
				} catch ( Exception e ) {
					path = "C:/Temp" ;
				}
...
class Arrow extends Tool {
	...
	//=========================================================================
	public Arrow() {
		Casinos.milesLabel.setText("DIST   0 mi   ");
		Casinos.kmLabel.setText("   0 km    ");
		Casinos.map.repaint();
		Casinos.helpToolOn = false ;
	}
}
...
class DistanceTool extends DragTool  {
	...
	public void mousePressed(MouseEvent me) {
		...
		initPoint = Casinos.map.transformPixelToWorld(me.getX(),me.getY());
	}
	...
	public void mouseReleased(MouseEvent me) {
		...
		endPoint = Casinos.map.transformPixelToWorld(me.getX(),me.getY());
		...
		Casinos.milesLabel.setText("DIST: " +
									 new Float((float)distance).toString()
									 + " mi  ");
		Casinos.kmLabel.setText(new Float((float)(distance*1.6093)).toString()
								  + " km");

		if (Casinos.acetLayer != null) {
			Casinos.map.remove(Casinos.acetLayer);
		}

		Casinos.acetLayer = new AcetateLayer() {
		...
		Casinos.map.add(Casinos.acetLayer);
		Casinos.map.redraw();
	}
