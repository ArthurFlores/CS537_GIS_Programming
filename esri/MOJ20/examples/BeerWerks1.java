...
// Project: San Diego County Casinos
//
// DESCRIPTION:
//
// In this project I visited, tasted and photographed 10 out of approximately
// 96 breweries in San Diego.
//
// The data set is broken into two feature layers "Breweries Reviewed" and
// "Breweries Not Reviewed".  There is also a base layer for SD County.
//
// The Breweries Reviewed layer will have a ESRI TrueType Font of a different
// color to differentiate the visited breweries from the large number of other
// breweries in scope but not visited, tasted or photographed.
//
// Each feature (brewery) in the map has the following attributes:
// #SHAPE#, ID, NAME, STREET, CITY, STATE, ZIPCODE, PHONE, URL, TASTEHOURS and
// RATING
//
// The information in the attribute table will be displayed to the user upon
// hotlink usage.  The hotlink tool will also enable a user to click a button
// and visit that brewery's website.  The same hotlink function is used across
// all layers and has conditional exeuction/formatting depending on the layer.
//
// Create Polygon Layer functionality has been preserved and extended to
// support Point Layers.
//
// The XY Tool which creates a layer from a CSV is preserved.  Upon loading a
// new CSV the icons used will be ESRI TrueType.
//
// Add/Remove/Promote/Demote layer functionality is preserved.
//
// Overall I enjoyed this project.  The topic was of interest and the coding
// was fun.  Thanks for the great class!
//
// ===========================================================================
...
//===========================================================================
public class BeerWerks extends JFrame {
	...
	String s1 = "C:/beerworks/data/sdcounty.shp";
	String s2 = "C:/beerworks/data/Breweries Reviewed.shp";
	String s3 = "C:/beerworks/data/Breweries Not Reviewed.shp";
	String datapathname = "";
	String legendname = "";
	...
	ImageIcon clico = new ImageIcon("C:/beerworks/img/icons/clico.jpg");
	ImageIcon tvico = new ImageIcon("C:/beerworks/img/icons/tableview.jpg") ;
	ImageIcon dslico = new ImageIcon("C:/beerworksimg/icons/demote.jpg") ;
	ImageIcon fmpico = new ImageIcon("C:/beerworks/img/icons/print.jpg") ;
	ImageIcon alico = new ImageIcon("C:/beerworks/img/icons/addtheme.jpg") ;
	ImageIcon rlico = new ImageIcon("C:/beerworks/img/icons/delete.jpg") ;
	ImageIcon leico = new ImageIcon("C:/beerworks/img/icons/properties.jpg") ;
	ImageIcon helpico = new ImageIcon("C:/beerworks/img/icons/help.png");
	static ImageIcon pslico = new ImageIcon("C:/beerworks/img/icons/promote.jpg") ;
	...
	JButton prtjb = new JButton(new ImageIcon("C:/beerworks/img/icons/print.jpg"));
	JButton addlyrjb = new JButton(new ImageIcon("C:/beerworks/img/icons/addtheme.jpg"));
	JButton ptrjb = new JButton(new ImageIcon("C:/beerworks/img/icons/pointer.jpg"));
	JButton distjb = new JButton(new ImageIcon("C:/beerworks/img/icons/measure_1.jpg"));
	JButton XYjb = new JButton("XY");
	JButton hotjb = new JButton(new ImageIcon("C:/beerworks/img/icons/hotlink-tbar.jpg"));
	JButton helptooljb = new JButton(new ImageIcon("C:/beerworks/img/icons/help2.png"));

	// Setup the hotlink tool here...
	Toolkit tk = Toolkit.getDefaultToolkit();
	Image bolt = tk.getImage("C:/beerworks/img/icons/hotlink.png");
			...
			public void actionPerformed(ActionEvent ae) {
				...
				if (source instanceof JMenuItem) {
					...
					if(arg == "Add Layer") {
						...
						ab.setProductName("BeerWerks");
						ab.setProductVersion("1.0");
						ab.setVisible(true) ;
					} else if (arg == "Contact Us"){
						try {
							String s = "\n\nInquiries should be addressed to: " ;
							s = s + "beerwerks@rohan.sdsu.edu." ;
	...
	public static void main(String[] args) {
		...
		BeerWerks qstart = new BeerWerks();
			...
			public void actionPerformed(ActionEvent ae) {
				...
				if (source == cancel) {
					...
					try {
						...
						map.redraw();
						if (BeerWerks.stb.getSelectedLayers() != null) {
							BeerWerks.pitem.setEnabled(true);
						}
					} catch(IOException e){}
				}
			}
...
class XYfeatureLayer extends BaseFeatureLayer {
	...
	public XYfeatureLayer(BasePointsArray bpa, Map map, Vector s2, Vector s3,
		...
		sms.setSizeX(30);
		sms.setSizeY(30);
		sms.setImageString("C:/Casinos/img/icons/cards1.png");
		srd.setSymbol(sms);
		setRenderer(srd);
	...
	*/
	...
	private void createDbfFields() {
		...
		fields.addField(new BaseField("TasteHrs",java.sql.Types.VARCHAR,32,0));
		fields.addField(new BaseField("Rating",java.sql.Types.VARCHAR,32,0));
	}
...
class AttrTab extends JDialog {
	JPanel panel1 = new JPanel();
	com.esri.mo2.map.dpy.Layer layer = BeerWerks.layer4;
	...
	ActionListener lis = new ActionListener() {
		public void actionPerformed(ActionEvent ae) {
			...
			if (o == nameField) {
				...
				try {
					//path = ((ShapefileFolder)(BeerWerks.layer4.getLayerSource())).getPath();
					path = "C:\\ESRI\\MOJ20\\EXAMPLES\\Homework3_ShapeFiles";
				} catch ( Exception e ) {
					path = "C:/Temp" ;
				}
...
class Arrow extends Tool {
	...
	//=========================================================================
	public Arrow() {
		BeerWerks.milesLabel.setText("DIST   0 mi   ");
		BeerWerks.kmLabel.setText("   0 km    ");
		BeerWerks.map.repaint();
		BeerWerks.helpToolOn = false ;
	}
}
...
class DistanceTool extends DragTool  {
	...
	public void mousePressed(MouseEvent me) {
		...
		initPoint = BeerWerks.map.transformPixelToWorld(me.getX(),me.getY());
	}
	...
	public void mouseReleased(MouseEvent me) {
		...
		endPoint = BeerWerks.map.transformPixelToWorld(me.getX(),me.getY());
		...
		BeerWerks.milesLabel.setText("DIST: " +
									 new Float((float)distance).toString()
									 + " mi  ");
		BeerWerks.kmLabel.setText(new Float((float)(distance*1.6093)).toString()
								  + " km");

		if (BeerWerks.acetLayer != null) {
			BeerWerks.map.remove(BeerWerks.acetLayer);
		}

		BeerWerks.acetLayer = new AcetateLayer() {
		...
		BeerWerks.map.add(BeerWerks.acetLayer);
		BeerWerks.map.redraw();
	}
...
class HotPick extends JDialog {
	...
	// Simple multidimentional array of strings for the photos I took...
	  String[][] b = new String[][] {
			{ "C:/Casinos/img/photos/barona.jpg"},
			{ "C:/Casinos/img/photos/pala.jpg"},
			{ "C:/Casinos/img/photos/lucky_lady.jpg"},
			{ "C:/Casinos/img/photos/palomar.jpg" },
			{ "C:/Casinos/img/photos/sycuan.jpg"},
			{ "C:/Casinos/img/photos/seven_mile.jpg"},
			{ "C:/Casinos/img/photos/viejas.jpg"},
			{ "C:/Casinos/img/photos/valley_view.jpg"},
			{ "C:/Casinos/img/photos/oceans_eleven.jpg"},
			{ "C:/Casinos/img/photos/pauma.jpg"},
			{ "C:/Casinos/img/photos/pechanga.jpg"}
		} ;

		/*String[][] b = new String[][] {
					{ "C:/beerworks/img/photos/ott/img_3871.JPG", "C:/beerworks/img/photos/ott/img_3874.JPG",
					  "C:/beerworks/img/photos/ott/img_3875.JPG", "C:/beerworks/img/photos/ott/img_3877.JPG",
					  "C:/beerworks/img/photos/ott/img_3879.JPG", "C:/beerworks/img/photos/ott/img_3880.JPG" },
