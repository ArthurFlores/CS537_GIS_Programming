...
function getMapImage(cmd) {
	...
	//alert("minx=" + minX + " miny=" + minY + " maxx=" + maxX + " maxy=" + maxY + " ### minx=>" + f.MinX.value);
	if (HasSelection) {
...
function identify(e) {
	...
	f.action = parent.MapFrame.MOJServerController;
	f.ServiceName.value = parent.MapFrame.ServiceName;
...
function loadServiceForm() {
	...
	//alert("List service controller=" + theForm.action);
	theForm.submit();
}
...
function refreshSelectionQueryFind() {
	...
	var cmd = parent.MapFrame.SelectionQueryFindCmd;
		...
		frm.SelectMinX.value = forceComma(parent.MapFrame.SelectMinX);
		frm.SelectMinY.value = forceComma(parent.MapFrame.SelectMinY);
		frm.SelectMaxX.value = forceComma(parent.MapFrame.SelectMaxX);
		frm.SelectMaxY.value = forceComma(parent.MapFrame.SelectMaxY);
		frm.QueryString.value = parent.MapFrame.QueryString;
		frm.FindString.value = parent.MapFrame.FindString;
		frm.action = parent.MapFrame.MOJServerController;
