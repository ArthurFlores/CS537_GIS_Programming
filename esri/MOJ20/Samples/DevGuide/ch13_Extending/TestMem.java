...
import memoryfeature.InMemoryFeatureClass;
 ...
 * a MemoryFeatureClass.
 */
public class TestMem extends JFrame {
  ...
  File testFile = new File ("C:ESRIa\\MOJ20a\\Samplesa\\DevGuidea\\ch13_Extendinga\\Capitols.ptxt");
  ...
  private void initLayer() throws Exception {
    BaseFeatureClass testClass = new InMemoryFeatureClass(testFile);
  ...
  private void initUi() {
    ...
    this.setTitle("Show the MemoryFeatureClass Strategy");
  }
