...
import spatialindex.SpxFeatureClass;
 ...
 * a BaseFeatureClass created using the spatial index strategy.
 */
public class TestSpx extends JFrame {
  ...
  private void initLayer() throws Exception {
    BaseFeatureClass testClass = new SpxFeatureClass(testFile);
  ...
  private void initUi() {
    ...
    this.setTitle("Show the Spatial Index Strategy");
  }

  public static void main (String[] args) {
    new TestSpx().setVisible(true);
  }
