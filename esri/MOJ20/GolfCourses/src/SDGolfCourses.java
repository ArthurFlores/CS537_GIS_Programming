...
class XYfeatureLayer extends BaseFeatureLayer {
	...
	private void createDbfFields() {
		...
		fields.addField(new BaseField("GolfcourseID", java.sql.Types.VARCHAR, 10,
                                      0));
		...
		fields.addField(new BaseField("VideoLink", java.sql.Types.VARCHAR, 100,
                                      0));
...
class HotPick extends JDialog {
	...
	HotPick(Feature f) throws IOException {
		...
		if (f.getDataID().getSource().trim().equalsIgnoreCase("MyPoints")) {
			...
			System.out.println("F1 ::" + f.getValue(1));
			System.out.println("F2 Golf Course is::" + f.getValue(2));
			System.out.println("F3 is::" + f.getValue(3));
			System.out.println("F4 is::" + f.getValue(4));
			System.out.println("F5 is::" + f.getValue(5));
			System.out.println("F6 is::" + f.getValue(6));
			System.out.println("F7 is::" + f.getValue(7));
			System.out.println("F8 is::" + f.getValue(8));

			final String imageName = f.getValue(7).toString();
        	...
        	addressArea.setText("   Address : " + (String) f.getValue(6));
			...
			phoneArea.setText("   Phone Number : " + (String) f.getValue(4));
			...
			final JButton phoneBtn = new JButton("Phone Number : \n"
                                                 + (String) f.getValue(4), new ImageIcon("data/phone.gif"));
			...
			final String webUrl = (String) f.getValue(5);
			final String videoLink = (String) f.getValue(8);
